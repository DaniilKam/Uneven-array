#pragma once
#ifndef _UNEVEN_2D_ARRAY_H_
#define _UNEVEN_2D_ARRAY_H_
...
public:
	...
	uint8_t wr(uint32_t Layer, uint32_t pos, TypeVar val);	//Writing val on layer in pos.
	TypeVar rd(uint32_t Layer, uint32_t pos);	//Reading val on layer in pos.
